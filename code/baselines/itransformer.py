"""Stub class for the iTransformer baseline.
...
Upstream code: https://github.com/thuml/iTransformer
...
2. Copy the model class body into :meth:`forward` and the training loop
   ...
   :func:`build_baseline`.
3. Re-run ``python scripts/run_all_experiments.py --baselines iTransformer``.
...
those as the iTransformer reference values.
"""
...
class iTransformerBaseline(BaseBaseline):
    """Stub for the iTransformer baseline. See module docstring."""
