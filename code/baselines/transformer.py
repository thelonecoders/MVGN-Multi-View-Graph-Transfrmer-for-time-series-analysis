"""Stub class for the Transformer baseline.
...
2. Copy the model class body into :meth:`forward` and the training loop
   ...
   :func:`build_baseline`.
3. Re-run ``python scripts/run_all_experiments.py --baselines Transformer``.
...
those as the Transformer reference values.
"""
...
class TransformerBaseline(BaseBaseline):
    """Stub for the Transformer baseline. See module docstring."""
