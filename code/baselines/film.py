"""Stub class for the FiLM baseline.
...
Reference
---------
Zhou et al., 2022, FiLM (NeurIPS 2022)
Upstream code: https://github.com/tianzhou2011/FiLM
...
2. Copy the model class body into :meth:`forward` and the training loop
   ...
   :func:`build_baseline`.
3. Re-run ``python scripts/run_all_experiments.py --baselines FiLM``.
...
those as the FiLM reference values.
"""
...
class FiLMBaseline(BaseBaseline):
    """Stub for the FiLM baseline. See module docstring."""
