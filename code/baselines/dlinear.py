"""Stub class for the DLinear baseline.
...
Reference
---------
Zeng et al., 2023, Are Transformers Effective for TSF? (AAAI 2023)
Upstream code: https://github.com/cure-lab/LTSF-Linear
...
2. Copy the model class body into :meth:`forward` and the training loop
   ...
   :func:`build_baseline`.
3. Re-run ``python scripts/run_all_experiments.py --baselines DLinear``.
...
those as the DLinear reference values.
"""
...
class DLinearBaseline(BaseBaseline):
    """Stub for the DLinear baseline. See module docstring."""
