"""Stub class for the FEDformer baseline.
...
Upstream code: https://github.com/MAZiqing/FEDformer
...
2. Copy the model class body into :meth:`forward` and the training loop
   ...
   :func:`build_baseline`.
3. Re-run ``python scripts/run_all_experiments.py --baselines FEDformer``.
...
those as the FEDformer reference values.
"""
...
class FEDformerBaseline(BaseBaseline):
    """Stub for the FEDformer baseline. See module docstring."""
